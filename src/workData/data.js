const data = [
	...
	},
	{
		...
		desc2:
			"I created Blackjack more quickly and with additional features than last time. In the previous Blackjack, the card pictures were managed with images, but this time I used the open source Card Api to display them. The data is passed between components by UseContext",
	},
	{
		title: "ToDoList [React + TypeScript, Firebase]",
